...
server<-function(input,output){
  ...
  output$customer_list<-renderDataTable({
    dbhandle1 <- odbcDriverConnect('driver={SQL Server};server=thaque2050.cgz0la30vrak.us-east-2.rds.amazonaws.com;port=1433;database=Group_Project_BUDT758Y;uid=thaque786;pwd=tariq214H')
  ...
  output$Word_Network_Positive<-renderPlot({
    ...
    dbhandle2 <- odbcDriverConnect('driver={SQL Server};server=thaque2050.cgz0la30vrak.us-east-2.rds.amazonaws.com;port=1433;database=Group_Project_BUDT758Y;uid=thaque786;pwd=tariq214H')
  ...
  output$Review_Sentiments<-renderPlotly({
    ...
    dbhandle3 <- odbcDriverConnect('driver={SQL Server};server=thaque2050.cgz0la30vrak.us-east-2.rds.amazonaws.com;port=1433;database=Group_Project_BUDT758Y;uid=thaque786;pwd=tariq214H')
  ...
  output$Leaflet_Customers<-renderLeaflet({
    ...
    dbhandle4 <- odbcDriverConnect('driver={SQL Server};server=thaque2050.cgz0la30vrak.us-east-2.rds.amazonaws.com;port=1433;database=Group_Project_BUDT758Y;uid=thaque786;pwd=tariq214H')
  ...
  query12 <- eventReactive(input$insert_data23, {
    ...
    dbhandle5 <- odbcDriverConnect('driver={SQL Server};server=thaque2050.cgz0la30vrak.us-east-2.rds.amazonaws.com;port=1433;database=Group_Project_BUDT758Y;uid=thaque786;pwd=tariq214H')
